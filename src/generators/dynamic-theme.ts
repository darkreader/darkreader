...
const dynamicThemeFixesCommands = {
    ...
    'INGORE IMAGE ANALYSE': 'ignoreImageAnalyse',
};
...
export function getDynamicThemeFixesFor(url: string, frameURL: string, fixes: DynamicThemeFix[], enabledForPDF: boolean) {
    ...
    const common = {
        ...
        ignoreImageAnalyse: fixes[0].ignoreImageAnalyse || [],
    };
    if (enabledForPDF) {
    ...
    return {
        ...
        ignoreImageAnalyse: common.ignoreImageAnalyse.concat(match.ignoreImageAnalyse || []),
    };
}
