...
export class Extension {
    ...
    private static readonly SYSTEM_COLOR_LOCAL_STORAGE_KEY =
        'system-color-state';
    ...
    public static async changeSettings(
        ...
        if (
            prev.enableContextMenus !== UserStorage.settings.enableContextMenus
        ) {
