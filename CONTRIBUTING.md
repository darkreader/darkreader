...
If certain **elements** of a web page are **incorrectly inverted or styled**,
...
If you execute `npm run debug:watch` instead of `npm run debug`, the project will be automatically recompiled
