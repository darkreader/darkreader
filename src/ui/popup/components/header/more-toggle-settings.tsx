...
export default function MoreToggleSettings({
    data,
    actions,
    isExpanded,
    onClose,
}: MoreToggleSettingsProps) {
            ...
            <div class="header__more-settings__content">
                    ...
                    <CheckBox
                        ...
                        onchange={(e: { target: HTMLInputElement }) =>
                            changeAutomationMode(
                                e.target.checked ? AutomationMode.TIME : AutomationMode.NONE
                            )
                        }
                    />
                    <TimeRangePicker
                ...
                <div class="header__more-settings__line header__more-settings__location">
                    <CheckBox
                        ...
                        onchange={(e: { target: HTMLInputElement }) =>
                            changeAutomationMode(
                                e.target.checked ? AutomationMode.LOCATION : AutomationMode.NONE
                            )
                        }
                    />
                    <TextBox
                ...
                >
                    <CheckBox
                        ...
                        onchange={(e: { target: HTMLInputElement }) =>
                            changeAutomationMode(
                                e.target.checked ? AutomationMode.SYSTEM : AutomationMode.NONE
                            )
                        }
                    />
                    <Button
                ...
                isSystemAutomation,
                        ...
                        onclick={() =>
                            changeAutomationMode(
                                isSystemAutomation ? AutomationMode.NONE : AutomationMode.SYSTEM
                            )
                        }
                    >
              ...
              data.shortcuts['toggle'],
                ...
                >
                    <Shortcut
                        ...
                        textTemplate={(hotkey) =>
                            hotkey ? hotkey : getLocalMessage('click_to_set_shortcut')
                        }
