...
test.skip('Absolute URL can be recovered from host and path', async () => {
    test.each([
        [['https://www.google.com', 'image.jpg'], 'https://www.google.com/image.jpg'],
        [['https://www.google.com', '/image.jpg'], 'https://www.google.com/image.jpg'],
        [['https://www.google.com/path', '/image.jpg'], 'https://www.google.com/image.jpg'],
        [['//www.google.com', '/image.jpg'], `${location.protocol}//www.google.com/image.jpg`],
        [['https://www.google.com', 'image.jpg?size=128'], 'https://www.google.com/image.jpg?size=128'],
        [['https://www.google.com/path', 'image.jpg'], 'https://www.google.com/image.jpg'],
        [['https://www.google.com/path/', 'image.jpg'], 'https://www.google.com/path/image.jpg'],
        [['https://www.google.com/long/path', '../image.jpg'], 'https://www.google.com/image.jpg'],
        [['https://www.google.com/long/path/', '../image.jpg'], 'https://www.google.com/long/image.jpg'],
        [['https://www.google.com/long/path/', '../another/image.jpg'], 'https://www.google.com/long/another/image.jpg'],
        [['https://www.google.com/path/page.html', 'image.jpg'], 'https://www.google.com/path/image.jpg'],
        [['https://www.google.com/path/page.html', '/image.jpg'], 'https://www.google.com/image.jpg'],
        [['https://www.google.com', '//www.google.com/path/image.jpg'], `${location.protocol}//www.google.com/path/image.jpg`],
        [['https://www.google.com', 'https://www.google.com/path/image.jpg'], 'https://www.google.com/path/image.jpg'],
        [['https://www.google.com', 'https://www.google.com/path/../another/image.jpg'], 'https://www.google.com/another/image.jpg'],
        [['https://www.google.com/path/page.html', 'image.jpg'], 'https://www.google.com/path/image.jpg'],
        [['https://www.google.com/path/page.html', '../image.jpg'], 'https://www.google.com/image.jpg'],
        [['path/index.html', 'image.jpg'], `${location.origin}/path/image.jpg`],
        [['path/index.html', '/image.jpg?size=128'], `${location.origin}/image.jpg?size=128`],
    ])('%p -> %p', async ([base, relative], want) => {
        const promise = page.evaluate(() => getAbsoluteURL(base, relative));
        await expect(promise).resolves.toBe(want);
    });
});
